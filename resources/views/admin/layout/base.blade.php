...
@section('body_class') class="page-header-fixed page-quick-sidebar-over-content page-style-square page-footer-fixed" @stop
@section('body')
	<!-- BEGIN HEADER -->
		...
		<div class="page-header-inner">
            ...
            <div class="top-menu">
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="dropdown">
                        <a href="/admin/logout" class="dropdown-toggle" style="width: 46px;">
	...
	<div class="page-container">
		<?php echo View::make("admin.layout.partials.menu"); ?>
		<!-- BEGIN CONTENT -->
	...
	<div class="modal fade" id="modal-delete" tabindex="-1" role="basic" aria-hidden="true">
		<form action="" method="post" class="form-horizontal deleteForm">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn blue modal-confirm">Si</button>
                    </div>
                </div>
                <!-- /.modal-content -->
            </div>
	...
	<!--CONFIRMATION MODAL -->
	<div class="modal fade" id="modal-general" tabindex="-1" role="basic" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
...
@section('javascript')
	...
	<script type="text/javascript" src="{{ asset('metronic/assets/global/plugins/tinymce/tinymce.min.js') }}"></script>
