    ...
    <div class="col-md-12">
        ...
        <div class="portlet box blue">
            ...
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
                <form action="/{{$prefix}}/roles/store" method="post" id="myForm" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            * </span>
                            ...
                            <div class="col-md-4">
                                <input type="text" name="name" value="{{strtoupper(Input::old("name"))}}" data-required="1" class="form-control"/>
                            </div>
                        </div>
                    </div>
