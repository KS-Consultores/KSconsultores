    ...
    <div class="col-md-12">
        <div class="portlet box blue">
            ...
            <div class="portlet-body form">
                <form action="/admin/posts/store" method="post" id="form_posts" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="form-body">
                            ...
                            <div class="col-md-4">
                                <select class="form-control select2" name="category_list[]" multiple>
                                    ...
                                    @foreach ($categories as $category)
                                        <option value="{{ $category->id }}" {{ in_array($category->id, old('category_list') ?: []) ? 'selected' : '' }}>{{ $category->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="checkbox" name="outstanding" class="make-switch" data-on-color="success" data-off-color="danger" data-on-text="{{ trans("posts.buttons.yes") }}" data-off-text="{{ trans("posts.buttons.no") }}" >
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">
                                {{ trans("posts.fields.image") }}   <span class="required"> * </span>
                            </label>
                            <div class="col-md-4">
                    ...
                    <div class="form-actions">
                        <div class="row">
                            ...
                            <div class="col-md-3" style="text-align: right;">
                                <button type="submit" class="btn green">{{ trans('posts.buttons.register') }}</button>
                            </div>
                        </div>
                    </div>
                </form>
