    ...
    */
    ...
    public function sendContact(){
        ...
        switch ($team) {
            ...
            case '3':
                $to = 'administracion@ksconsultores.com.mx';
                $team_name = "Ks Consultores Auditor&Atilde;&shy;a";
                $type = 'Auditor&Atilde;&shy;a';
                break;
            case '4':
                $to = 'administracion@ksconsultores.com.mx';
        ...
        $data = array(
            ...
            Mail::send('front.emails.contact', $data, function($message) use ($data){
                ...
                $message->bcc('helloworld@freddyarvizu.com', 'KS Consultores web');
            ...
            $results = [
                "status" => 'ok',
                "message" => 'El envío se realizó con éxito'
            ];
